...
if __name__ == "__main__":
    cleardb()
    print("Single insert 1 (10 message):")
    TestSingleInsertSpeed('timescale/test/msgs/msgs10', 48)
    cleardb()
    print("Single insert 2 (100 messages):")
    TestSingleInsertSpeed('timescale/test/msgs/msgs100', 480)
    cleardb()
    print("Single insert 3 (1000 messages):")
    TestSingleInsertSpeed('timescale/test/msgs/msgs1k', 5330)
    cleardb()
    print("Bulk insert 1 (10 messages):")
    TestBulkInsertSpeed('timescale/test/msgs/msgs10', 48)
    cleardb()
    print("Bulk insert 2 (100 messages):")
    TestBulkInsertSpeed('timescale/test/msgs/msgs100', 480)
    cleardb()
    print("Bulk insert 3 (1000 messages):")
    TestBulkInsertSpeed('timescale/test/msgs/msgs1k', 5330)
    cleardb()
    print("Bulk insert 4 (10000 messages):")
    TestBulkInsertSpeed('timescale/test/msgs/msgs10k', 53300)
    cleardb()
    print("Bulk insert 5 (25000 messages):")
    TestBulkInsertSpeed('timescale/test/msgs/msgs25k', 135450)
    TestQuerySpeed()
